<?php
	...
	//load golden results array from file
	...
	/* ----------Google----------*/
	echo '<h2>Google Statistics</h2><hr/>';
	?>
	...
	$TREC_no = 151 + $qry;
		...
		$FMAvg += $FM;
		$ResultArray = array();
	}// end for loop, looping through all queries
	$MAP = $MAP / $qry;
	$FMAvg = $FMAvg / $qry;
	...
	/* ----------Blekko----------*/
	echo '<h2>Blekko Statistics</h2><hr/>';
	?>
